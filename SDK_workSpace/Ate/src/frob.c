...
void frob_p3 (elemFp12 a, elemFp12 *res){
	//frob_p2(a,res);
    //frob_p(*res,res);
    ...
    ///************** Calculs **********************
    mulCFp2((*res).w1.v0,y31,(*res).w1.v0);
    mulCFp2((*res).w0.v1,y32,(*res).w0.v1);
    mulCFp2((*res).w1.v1,y33,(*res).w1.v1);
    mulCFp2((*res).w0.v2,y34,(*res).w0.v2);
    mulCFp2((*res).w1.v2,y35,(*res).w1.v2);
