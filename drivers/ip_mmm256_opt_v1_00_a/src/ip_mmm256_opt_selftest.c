/*****************************************************************************
* Filename:          E:\Code_Doctorat_Virtex5\Base_System_MMM/drivers/ip_mmm256_opt_v1_00_a/src/ip_mmm256_opt_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the ip_mmm256_opt driver
...
XStatus IP_MMM256_OPT_SelfTest(void * baseaddr_p)
{
  ...
  IP_MMM256_OPT_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = IP_MMM256_OPT_mReadSlaveReg0(baseaddr, 0);
  ...
  IP_MMM256_OPT_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = IP_MMM256_OPT_mReadSlaveReg1(baseaddr, 0);
  ...
  IP_MMM256_OPT_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = IP_MMM256_OPT_mReadSlaveReg2(baseaddr, 0);
